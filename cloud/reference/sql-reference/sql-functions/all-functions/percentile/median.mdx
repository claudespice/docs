...
#### MEDIAN(_order\_by\_expression_ numeric) → double precision
...
This function is equivalent to [`PERCENTILE_CONT(0.5) WITHIN GROUP(ORDER BY order_by_expression)`](percentile\_cont).
