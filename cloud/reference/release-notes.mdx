...
<Frame caption="New Data Source dialog for connecting external data sources.">
  <img src="/images/image (1) (1) (1).png" alt="" />
</Frame>
...
<Frame caption="The new navigation command bar.">
  <img src="/images/image (1) (1) (1) (1).png" alt="" />
</Frame>
...
See [federated-sql-query.md](/cloud/features/federated-sql-query) for full documentation on deploying datasets to the Spice Firecache.
...
See [datasets-and-views.md](/cloud/portal/datasets-and-views) for full documentation on creating private Datasets and Views.
...
See [connect-github.md](/cloud/portal/apps/connect-github) for full documentation on connecting your Github Repo to a Spice App.
...
<Frame caption="Latest view of all Aave V2 loans query, sample output">
  <img src="/images/Screen Shot 2023-05-09 at 9.49.27 AM.png" alt="" />
</Frame>
...
<Frame caption="Get ETH withdrawn after the Ethereum Shanghai upgrade, sample output">
  <img src="/images/Screen Shot 2023-05-10 at 10.20.00 PM.png" alt="" />
</Frame>
...
<Frame caption="Recently updated validators, with their balance and status by querying from <code>goerli.beacon.validators</code>, sample output">
  <img src="/images/Screen Shot 2023-05-09 at 8.33.15 PM.png" alt="" />
</Frame>
