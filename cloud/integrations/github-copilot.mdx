...
<Frame caption="The @spiceai extension in GitHub Copilot.">
  <img src="/images/Screenshot 2024-10-23 at 15.45.09.png" alt="The @spiceai extension in GitHub Copilot." />
</Frame>
...
<Frame caption="The Spice.ai Extension in the GitHub Marketplace.">
  <img src="/images/image (38).png" alt="The Spice.ai Extension in the GitHub Marketplace." />
</Frame>

Scroll down, and click **Install it for free**.

<Frame caption="Install the Community Edition of the Spice.ai Extension for free.">
  <img src="/images/image (39).png" alt="Install the Community Edition of the Spice.ai Extension for free." />
</Frame>
...
<Frame caption="Starting a conversaton with @spiceai">
  <img src="/images/copilot_chat_again.png" alt="Starting a conversaton with @spiceai" />
</Frame>

2. A prompt will appear to connect to the Spice.ai Cloud Platform.

<Frame caption="Connection prompt">
  <img src="/images/copilot_connect.png" alt="Connection prompt" />
</Frame>
...
<Frame caption="Permissions screen for the Spice AI Extension">
  <img src="/images/copilot_authorize.png" alt="Permissions screen for the Spice AI Extension" />
</Frame>
...
<Frame caption="Authorizing the Spice.ai Cloud Platform">
  <img src="/images/copilot_authorize_platform.png" alt="Authorizing the Spice.ai Cloud Platform" />
</Frame>
...
<Frame caption="GitHub Copilot Extension Setup page">
  <img src="/images/copilot_extension_setup.png" alt="GitHub Copilot Extension Setup page" />
</Frame>
...
<Frame caption="GitHub Copilot Extension Deployment page">
  <img src="/images/copilot_start_instance.png" alt="GitHub Copilot Extension Deployment page" />
</Frame>
...
<img src="/images/copilot_portal.png" alt="Spice.ai Portal" />
</Step>

<Step>
### Click the `copilot` app

<img src="/images/copilot_portal_app.png" alt="Copilot app in the Portal" />
...
<img src="/images/copilot_show_tables.png" alt="Show tables query result" />
</Step>
...
<img src="/images/copilot_select.png" alt="SQL query results for repository content" />
</Step>
</Steps>
...
<img src="/images/copilot_reset_user.png" alt="Account menu in the top-right corner" />
</Step>

<Step>
### Click Account Settings

<img src="/images/copilot_reset_settings.png" alt="Account Settings page" />
</Step>

<Step>
### Click GitHub Copilot

<img src="/images/copilot_reset_copilot.png" alt="GitHub Copilot settings" />
</Step>

<Step>
### Click Reset GitHub Copilot config

<img src="/images/copilot_reset_config.png" alt="Reset GitHub Copilot configuration" />
</Step>
</Steps>
