...
<Frame caption="Navigating to plugins and data in Grafana, and searching for FlightSQL">
  <img src="/images/grafana-datasource-2.png" alt="Navigating to plugins and data in Grafana, and searching for FlightSQL" />
</Frame>
...
<Frame caption="The FlightSQL plugin menu, once the plugin is installed.">
  <img src="/images/grafana-datasource-3.png" alt="The FlightSQL plugin menu, once the plugin is installed." />
</Frame>
...
* `Token` - set to your [Spice.ai API key](/cloud/portal/apps/api-keys). 
...
<Frame caption="Setting up a FlightSQL datasource to connect to Spice.ai Cloud Platform">
  <img src="/images/image (42).png" alt="Setting up a FlightSQL datasource to connect to Spice.ai Cloud Platform" />
</Frame>
...
<Frame caption="Select the FlightSQL datasource for the visualization">
  <img src="/images/image (43).png" alt="Select the FlightSQL datasource for the visualization" />
</Frame>
...
<Frame caption="A Grafana line graph displaying the most recent query execution times">
  <img src="/images/image (44).png" alt="A Grafana line graph displaying the most recent query execution times" />
</Frame>
...
<Frame caption="Manually refreshing the visualization query in FlightSQL">
  <img src="/images/image (45).png" alt="Manually refreshing the visualization query in FlightSQL" />
</Frame>
