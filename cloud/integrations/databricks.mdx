...
<Frame caption="Add new Databricks OAuth connection">
  <img src="/images/databricks-add-connection.png" alt="Add new Databricks OAuth connection" />
</Frame>

After creating the connection, copy the generated OAuth client ID:

<Frame caption="Copy Databricks Client ID">
  <img src="/images/databricks-connection-client-id.png" alt="Copy Databricks Client ID" />
</Frame>
...
<Frame caption="Databricks connector in code editor">
  <img src="/images/spicepod-editor (1).png" alt="Databricks connector in code editor" />
</Frame>
...
<Frame caption="Set Databricks workspace URL and Client ID">
  <img src="/images/new-databricks-connection (1).png" alt="Set Databricks workspace URL and Client ID" />
</Frame>
...
<Frame caption="Code editor with Databricks catalog, dataset and model">
  <img src="/images/spicepod-editor-dataset (1).png" alt="Code editor with Databricks catalog, dataset and model" />
</Frame>
