...
To report a vulnerability, see: [report.md](/cloud/security/report)
...
A copy of the SOC 2 Audit Report is available to customers subscribed to the [Spice.ai Enterprise plan](/cloud/pricing/plans) upon request.
