...
The  [`Client.query`](/cloud/sdks/node.js-sdk/api-reference#spiceclient-methods) function takes an optional `onData` callback that will be passed partial results as they become available.
