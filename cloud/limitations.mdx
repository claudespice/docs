...
* 500 row limit for HTTP API results (use the [Apache Arrow API](api/sql-query-api/apache-arrow-flight-api) or the [Async HTTP API](api/sql-query-api/http-api-1) for no limit).
