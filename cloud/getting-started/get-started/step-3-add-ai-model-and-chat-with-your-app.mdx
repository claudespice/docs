...
![](</images/CleanShot 2024-12-19 at 11.52.06 (1).gif>)
...
<Frame caption="Asking questions of the NYC Taxi Trips dataset in the AI Chat Playground.">
  <img src="/images/CleanShot 2024-12-19 at 12.22.38@2x.png" alt="Asking questions of the NYC Taxi Trips dataset in the AI Chat Playground." />
</Frame>
...
<Frame caption="Calling the chat completions API to chat wit the NYC Taxi Trips dataset.">
  <img src="/images/CleanShot 2024-12-19 at 12.42.00@2x.png" alt="Calling the chat completions API to chat wit the NYC Taxi Trips dataset." />
</Frame>

🎉 Congratulations, you've now added an OpenAI model and can use it to ask questions of the NYC Taxi Trips dataset.

Continue to [Next Steps](/cloud/getting-started/get-started/next-steps) to explore use-cases to do more with the Spice.ai Cloud Platform.
