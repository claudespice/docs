...
• For additional details, refer to the [Apache Arrow Flight API documentation](/cloud/api/sql-query/apache-arrow-flight-api).
...
• For more details, consult the [HTTP SQL API documentation](/cloud/api/sql-query/http-api).
