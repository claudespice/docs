...
It's recommended to use the Spice.ai SDKs to connect and query the Arrow Flight endpoint. SDKs are available for [Python](../../sdks/python-sdk/), [Node.js](../../sdks/node.js-sdk/), [Go](../../sdks/go), [Rust](../../sdks/rust-sdk/), [Java](../../sdks/java-sdk), and [Dotnet](../../sdks/dotnet-sdk).
