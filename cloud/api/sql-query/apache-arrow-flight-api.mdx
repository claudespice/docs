...
This setup enables high-speed access to your data in [Python](https://arrow.apache.org/docs/python/index.html), [Go](https://pkg.go.dev/github.com/apache/arrow/go/v8), [C++](https://arrow.apache.org/docs/cpp/index.html), [C#](https://github.com/apache/arrow/blob/master/csharp/README), [Rust](https://docs.rs/arrow-flight/latest/arrow_flight/), [Java](https://arrow.apache.org/docs/java/index.html), and [C#](https://github.com/apache/arrow/blob/main/csharp/README) and makes it easy to use libraries like [Pandas](https://arrow.apache.org/docs/python/pandas.html) and [NumPy](https://arrow.apache.org/docs/python/numpy.html?highlight=numpy).

### SDKs

It's recommended to use the Spice.ai SDKs to connect and query the Arrow Flight endpoint. SDKs are available for [Python](/cloud/sdks/python-sdk), [Node.js](/cloud/sdks/node.js-sdk), [Go](/cloud/sdks/go), [Rust](/cloud/sdks/rust-sdk), [Java](/cloud/sdks/java-sdk), and [Dotnet](/cloud/sdks/dotnet-sdk).
...
See the [Python SDK page](/cloud/sdks/python-sdk#m1-macs) for installation steps.
</Info>
...
* [Table](https://github.com/spicehq/cloud-docs/blob/trunk/api/sql-query-api/broken-reference/README) names must be fully-qualified. For example `spiceai.quickstart`
