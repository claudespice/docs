...
<mark style="color:blue;">`GET`</mark> `https://api.spice.ai/v1/apps/{appId}/secrets`
...
<mark style="color:blue;">`GET`</mark> `https://api.spice.ai/v1/apps/{appId}/secrets/{secretName}`
...
<mark style="color:green;">`POST`</mark> `https://api.spice.ai/v1/apps/{appId}/secrets`
...
<mark style="color:red;">`DELETE`</mark> `https://api.spice.ai/v1/apps/{appId}/secrets/{secretName}`
