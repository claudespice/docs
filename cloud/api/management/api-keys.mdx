...
API keys are available as an attribute on the `spiceai_app` resource. See [Terraform Provider](/cloud/api/management/terraform#spiceai_app) for full documentation.
...
- [Apps API](/cloud/api/management/apps) - Manage your apps
- [Portal API Keys](/cloud/portal/apps/api-keys) - View keys in the portal
- [SQL Query API](/cloud/api/sql-query) - Query your data
- [AI Gateway](/cloud/features/ai-gateway) - Use AI models
