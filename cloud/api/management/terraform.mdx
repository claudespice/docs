...
The provider authenticates using [OAuth 2.0 Client Credentials](/cloud/api/management#id-2.-oauth-2.0-client-credentials). Create an OAuth client in the [Spice.ai Portal](https://spice.ai) under **Settings** → **OAuth Clients**.
...
* [Management API Overview](/cloud/api/management)