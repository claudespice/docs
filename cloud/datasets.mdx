...
#### [Ethereum datasets](/cloud/reference/sql-query-tables/ethereum)
...
#### [Prices datasets](/cloud/reference/sql-query-tables/prices)
...
<Info>
For historical price exchange data to tick level granularity, try the [time-series Prices API](api/prices).
</Info>
...
#### [Spot and historical Prices](api/prices)
...
- See [JSON RPC Methods](/cloud/datasets#time-series-datasets-1)
