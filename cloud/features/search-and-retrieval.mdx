...
### SQL-Based Search[​](https://docs.spiceai.org/features/search#sql-based-search)
...
Spice also supports vector search on datasets with preexisting embeddings. See [below](/cloud/features/search-and-retrieval#pre-existing-embeddings) for compatibility details.

### Chunking Support[​](https://docs.spiceai.org/features/search#chunking-support)
...
### Document Retrieval[​](https://docs.spiceai.org/features/search#document-retrieval)
