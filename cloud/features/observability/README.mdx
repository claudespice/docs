...
Observability in Spice enables task tracking and performance monitoring through a built-in distributed tracing system that can [export to Zipkin](/cloud/features/observability/zipkin) or be viewed via the [`runtime.task_history`](/cloud/features/observability/task-history) SQL table.
...
<Frame caption="An observability trace for an AI chat completion in the Spice portal.">
  <img src="/images/observability_ai_chat_trace.png" alt="Observability trace for an AI chat completion" />
</Frame>
