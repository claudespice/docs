...
### Supported Models[​](https://docs.spiceai.org/features/large-language-models#configuring-language-models)
...
### Core Features[​](https://docs.spiceai.org/features/large-language-models#core-features)
...
### Example: Configuring an OpenAI Compatible Model[​](https://docs.spiceai.org/features/large-language-models#example-configuring-an-openai-model)
