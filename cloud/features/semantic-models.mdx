...
The semantic model is automatically used by [Spice Models](../building-blocks/spice-models) as context to produce more accurate and context-aware AI responses.
