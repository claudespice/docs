...
The HTTP(s) Data Connector enables federated SQL query across [supported file formats](/cloud/building-blocks/data-connectors#object-store-file-formats) stored at an HTTP(s) endpoint.
...
The `from` field must contain a valid URI to the location of a [supported file](/cloud/building-blocks/data-connectors#object-store-file-formats). For example, `http://static_username@my-http-api/report.csv`.
