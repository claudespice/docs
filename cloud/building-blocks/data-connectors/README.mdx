...
| [CSV](/cloud/reference/file-format#csv) | `file_format: csv`     | ✅         | ❌                  |
...
File formats support additional parameters in the `params` (like `csv_has_header`) described in [File Formats](/cloud/reference/file-format)

If a format is a document format, each file will be treated as a document, as per [document support](/cloud/building-blocks/data-connectors#document-support) below.
