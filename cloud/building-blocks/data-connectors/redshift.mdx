...
Amazon Redshift is a columnar OLAP database compatible with PostgreSQL. To connect Redshift to Spice, use the [PostgreSQL data connector](/cloud/building-blocks/data-connectors/postgres) and specify the Redshift cluster connection parameters.
...
Redshift types are mapped to PostgreSQL types. See the [PostgreSQL connector documentation](/cloud/building-blocks/data-connectors/postgres) for details on supported types and configuration.

## References

- [Amazon Redshift Documentation](https://docs.aws.amazon.com/redshift/latest/mgmt/welcome.html)
- [PostgreSQL Connector Documentation](/cloud/building-blocks/data-connectors/postgres)