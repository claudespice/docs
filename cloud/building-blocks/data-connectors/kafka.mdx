...
The Kafka Data Connector enables direct acceleration of data from [Apache Kafka](https://kafka.apache.org/) topics using `refresh_mode: append` [acceleration](/cloud/building-blocks/data-accelerators). This provides integration with existing Kafka-based event streaming infrastructure for real-time data acceleration and analytics.
...
<Warning>
Using the Kafka connector **requires** [acceleration](/cloud/building-blocks/data-accelerators) with `refresh_mode: append` enabled.
</Warning>
