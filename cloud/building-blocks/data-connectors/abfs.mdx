...
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file_format`               | Specifies the data format. Required if not inferrable from `from`. Options: `parquet`, `csv`. Refer to [Object Store File Formats](/cloud/building-blocks/data-connectors#object-store-file-formats) for details. |
...
Specify the file format using `file_format` parameter. More details in [Object Store File Formats](/cloud/building-blocks/data-connectors#object-store-file-formats).
