...
| [`file`](../embeddings/local) | Local filesystem                       | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
| [`huggingface`](huggingface) | Models hosted on HuggingFace            | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
| [`spice.ai`](spiceai)   | Models hosted on the Spice.ai Cloud Platform | Release Candidate | ONNX         | OpenAI-compatible HTTP endpoint |
| [`azure`](azure)        | Azure OpenAI                                 | Alpha             | -            | OpenAI-compatible HTTP endpoint |
| [`anthropic`](anthropic) | Models hosted on Anthropic                  | Alpha             | -            | OpenAI-compatible HTTP endpoint |
