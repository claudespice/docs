...
| -------------------------- | -------------------------------------------- | ----------------- | ------------ | ------------------------------- |
| [`openai`](/cloud/building-blocks/model-providers/openai)      | OpenAI (or compatible) LLM endpoint          | Stable            | -            | OpenAI-compatible HTTP endpoint |
| [`bedrock`](/cloud/building-blocks/model-providers/bedrock)    | Amazon Bedrock                               | Alpha             | -            | OpenAI-compatible HTTP endpoint |
| [`xai`](/cloud/building-blocks/model-providers/xai)            | Models hosted on xAI                         | Alpha             | -            | OpenAI-compatible HTTP endpoint |
| [`file`](/cloud/building-blocks/embeddings/local) | Local filesystem                       | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
| [`huggingface`](/cloud/building-blocks/model-providers/huggingface) | Models hosted on HuggingFace            | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
| [`spice.ai`](/cloud/building-blocks/model-providers/spiceai)   | Models hosted on the Spice.ai Cloud Platform | Release Candidate | ONNX         | OpenAI-compatible HTTP endpoint |
| [`azure`](/cloud/building-blocks/model-providers/azure)        | Azure OpenAI                                 | Alpha             | -            | OpenAI-compatible HTTP endpoint |
| [`anthropic`](/cloud/building-blocks/model-providers/anthropic) | Models hosted on Anthropic                  | Alpha             | -            | OpenAI-compatible HTTP endpoint |
| [`databricks`](/cloud/building-blocks/model-providers/databricks) | Models deployed to Databricks Mosaic AI   | Alpha             | -            | OpenAI-compatible HTTP endpoint |
...
To use a language model hosted on OpenAI (or compatible), specify the `openai` path and model ID in `from`. For more details, see [OpenAI Model Provider](/cloud/building-blocks/model-providers/openai).
