...
<Frame caption="Spice Models defined in <code>model.yaml</code> files automatically detected and imported in the Portal.">
  <img src="/images/CleanShot 2024-01-30 at 10.49.30@2x.png" alt="Spice Models defined in model.yaml files automatically detected and imported in the Portal." />
</Frame>
...
<Frame caption="Details for a specific Model.">
  <img src="/images/CleanShot 2024-01-30 at 10.51.58@2x.png" alt="Details for a specific Model." />
</Frame>
...
<Frame caption="A model training with status 'Running'.">
  <img src="/images/CleanShot 2024-01-30 at 10.53.08@2x.png" alt="A model training with status 'Running'." />
</Frame>
...
<Frame caption="A successfully completed Model training run with status 'Complete'.">
  <img src="/images/CleanShot 2024-01-30 at 10.55.32@2x.png" alt="A successfully completed Model training run with status 'Complete'." />
</Frame>
...
<Frame caption="The AI Predictions playground.">
  <img src="/images/CleanShot 2024-01-30 at 11.02.00@2x.png" alt="The AI Predictions playground." />
</Frame>
...
<Frame caption="Detailed training run page with the predictions API">
  <img src="/images/CleanShot 2024-01-30 at 11.00.34@2x.png" alt="Detailed training run page with the predictions API" />
</Frame>
