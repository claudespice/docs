...
| `cayenne`  | [Cayenne](/cloud/building-blocks/data-accelerators/cayenne)           | Alpha (v1.9.0-rc.1+) | `file`           |
| `duckdb`   | Embedded [DuckDB](/cloud/building-blocks/data-accelerators/duckdb)    | Stable               | `memory`, `file` |
| `postgres` | Attached [PostgreSQL](/cloud/building-blocks/data-accelerators/postgres/index) | Release Candidate    | N/A              |
| `sqlite`   | Embedded [SQLite](/cloud/building-blocks/data-accelerators/sqlite)    | Release Candidate    | `memory`, `file` |
...
In-memory limitations can be mitigated by storing acceleration data on disk, which is supported by [`duckdb`](/cloud/building-blocks/data-accelerators/duckdb) and [`sqlite`](/cloud/building-blocks/data-accelerators/sqlite) accelerators by specifying `mode: file`.
</Warning>