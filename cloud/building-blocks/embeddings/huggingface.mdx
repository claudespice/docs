...
- Any Huggingface repository with the correct files to be loaded as a [local embedding model](/cloud/building-blocks/embeddings/local).

With the same semantics as [language models](/cloud/building-blocks/model-providers/huggingface#access-tokens), `spice` can run private HuggingFace embedding models:
