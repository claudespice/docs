...
Connecting your Spice.ai app to a GitHub repository allows you to create custom [Datasets and Views](/cloud/portal/apps/datasets-beta), add datasets to Spice Firecache, author [Spice Functions](spice-functions/), and train AI Models.
...
<Frame caption="Creating a new repository using the spice-app-template">
  <img src="/images/CleanShot 2023-07-26 at 12.14.05@2x.png" alt="Creating a new repository using the spice-app-template" />
</Frame>
...
<Frame caption="Connecting a Spice.ai app to a GitHub repository.">
  <img src="/images/CleanShot 2023-07-26 at 12.12.24@2x.png" alt="Connecting a Spice.ai app to a GitHub repository." />
</Frame>
...
<Frame caption="Installing the Spice.ai GitHub app.">
  <img src="/images/CleanShot 2023-07-26 at 12.12.34@2x.png" alt="Installing the Spice.ai GitHub app." />
</Frame>
