...
### Structure[​](https://docs.spiceai.org/getting-started/spicepods#structure)
...
### Example Manifest[​](https://docs.spiceai.org/getting-started/spicepods#example-manifest)
...
### Key Components[​](https://docs.spiceai.org/getting-started/spicepods#key-components)

#### Datasets[​](https://docs.spiceai.org/getting-started/spicepods#datasets)

Datasets in a Spicepod can be sourced from various locations, including local files or remote databases. They can be materialized and accelerated using different engines such as DuckDB, SQLite, or PostgreSQL to optimize performance ([learn more](/cloud/features/data-acceleration)).

#### Catalogs[​](https://docs.spiceai.org/getting-started/spicepods#catalogs)
...
#### Models[​](https://docs.spiceai.org/getting-started/spicepods#models)
