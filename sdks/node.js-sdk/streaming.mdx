...
The  [`Client.query`](api-reference#spiceclient-methods) function takes an optional `onData` callback that will be passed partial results as they become available.
