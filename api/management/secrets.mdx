...
Use the `spiceai_secret` resource to manage secrets. See [Terraform Provider](terraform#spiceai_secret) for full documentation.
...
- [Apps API](apps) - Use secrets in your spicepod configuration
- [Portal Secrets](../../portal/apps/secrets) - Manage secrets in the portal
