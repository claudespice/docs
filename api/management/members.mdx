...
Use the `spiceai_member` resource to manage members. See [Terraform Provider](terraform#spiceai_member) for full documentation.
...
- [Organizations](../../portal/organizations) - Manage organizations in the portal
- [Apps API](apps) - Create apps for your team
- [Personal Access Tokens](../../portal/profile/personal-access-tokens) - Create tokens for team members
