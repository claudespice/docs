...
3. **Deploy** - Create a deployment (see [Deployments API](deployments))
...
Use the `spiceai_app` resource to manage apps. See [Terraform Provider](terraform#spiceai_app) for full documentation.
...
- [Deployments API](deployments) - Deploy your app
- [Secrets API](secrets) - Manage app secrets
- [API Keys](api-keys) - Manage app API keys
