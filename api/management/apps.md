...
<mark style="color:blue;">`GET`</mark> `https://api.spice.ai/v1/apps`
...
<mark style="color:green;">`POST`</mark> `https://api.spice.ai/v1/apps`
...
<mark style="color:blue;">`GET`</mark> `https://api.spice.ai/v1/apps/{appId}`
...
<mark style="color:orange;">`PUT`</mark> `https://api.spice.ai/v1/apps/{appId}`
...
<mark style="color:red;">`DELETE`</mark> `https://api.spice.ai/v1/apps/{appId}`
...
3. **Deploy** - Create a deployment (see [Deployments API](deployments.md))
