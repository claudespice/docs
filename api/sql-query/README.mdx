...
• For additional details, refer to the [Apache Arrow Flight API documentation](apache-arrow-flight-api).
...
• For more details, consult the [HTTP SQL API documentation](http-api).
