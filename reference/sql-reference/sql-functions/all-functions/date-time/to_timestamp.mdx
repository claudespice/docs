...
#### TO\_TIMESTAMP(_numeric\_expression_ double) → timestamp
...
-- 2022-01-01 00:00:00
```
#### TO\_TIMESTAMP(_string\_expression_ varchar, _format_ varchar, _replaceErrorWithNull_ int32) → timestamp
...
-- NULL
```
#### TO\_TIMESTAMP(_numeric\_expression_ int64) → timestamp
...
-- 2021-12-22 00:00:00
```
#### TO\_TIMESTAMP(_numeric\_expression_ int32) → timestamp
...
-- 2021-12-22 00:00:00
```
#### TO\_TIMESTAMP(_numeric\_expression_ float) → timestamp
...
-- 2022-01-01 00:00:00
```
#### TO\_TIMESTAMP(_string\_expression_ varchar, _format_ varchar) → timestamp
