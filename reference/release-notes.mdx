...
* **AI SQL Function (Preview)** – Query LLMs directly in [SQL](../portal/playground/sql-query-editor) with `ai()` for summarization, classification, or translation.
...
* Enhanced [vector search](../use-cases/enterprise-search#vector-similarity-search-across-disparate-and-legacy-data-systems) stability and default limits (now up to 1,000 results).
* Improved AI [SQL query](../portal/playground/sql-query-editor) consistency and async handling.
...
* **Databricks Integration**
  OAuth for [Databricks](../integrations/databricks) is fully automatic; your tokens are handled behind the scenes for all catalog, SQL, and chat actions.
...
* **Data & Secrets**
  [All secret](../portal/apps/secrets) names must be uppercase—system now enforces this for new and updated secrets.
...
* **Monitoring Enhancements**
  [New app and model performance views](../portal/monitoring-and-request-logs) allow users to see live status and recent activity for the apps and models they own.
...
* **AI Chat & Playground**
  New session handling: users can revisit prior conversations and access a catalog explorer from [Playground](../portal/playground/ai-chat). Improvements to chat UI display make longer chat sessions and code completions easier to review. Markdown and progress rendering are now supported in chat.
* **Spicepod Editor**
...
* **Copilot & Spicepod Integration**
  [The Copilot onboarding flow](../integrations/github-copilot) is now unified and leverages shared spicepod instances for organizational consistency. Deployment status and logs are directly viewable in the Copilot UI.
* **Editor Enhancements**
...
The November release focused on [External Data Sources](../portal/external-data-sources) and overall performance improvements following the [General Availability (GA)](https://blog.spice.ai/spice-ai-is-generally-available-d76c4289960c) release in October.
...
1. \[Portal] Added PostgreSQL and MySQL external data sources. See the [docs](../portal/external-data-sources) for details.
...
General Availability launches a brand-new collaborative developer experience, v1 APIs and SDKs, over [100 open-source community](https://github.com/spiceai/datasets) and [EigenLayer](/broken/pages/szea7RdCSxE1KLlrSpca) datasets, and a removal of the waitlist. Any developer can now sign-up and use Spice.ai with one of the new [pricing plans](../pricing/plans), including the $99 developer plan and the complementary [Community Edition](/broken/pages/TswKQuxvMpeSWfvqFhxa).
...
4. \[Portal] Datasets and Views generally available, [learn more](release-notes#datasets-and-views).
...
The August release expands the functionality of [Spice Functions](/broken/pages/aBmaUV0vHCWOQ4ioYk6o) (beta) and [Datasets and Views](../portal/datasets-and-views).
...
See [Broken link](/broken/pages/aBmaUV0vHCWOQ4ioYk6o) for full documentation on creating and deploying Spice Functions.
...
See [federated-sql-query.md](../features/federated-sql-query) for full documentation on deploying datasets to the Spice Firecache.
...
See [datasets-and-views.md](../portal/datasets-and-views) for full documentation on creating private Datasets and Views.
...
See [connect-github.md](../portal/apps/connect-github) for full documentation on connecting your Github Repo to a Spice App.
...
6. \[Flow] Added datasets detailing transfers of NFTs and tokens on the Flow blockchain, for more details see [Broken link](/broken/pages/G6NYPF18ou1tMQpmQ0PU)
...
* Added export to CSV results format in addition to existing formats [JSON](/broken/pages/w4hRmvPIKXDjLDknyEl6) and [Apache Arrow](../api/sql-query/apache-arrow-flight-api), for easy use with apps, ML, or libraries like NumPy and Pandas
...
* [Broken link](/broken/pages/YphzWK8SmAbgWoDBCGMW) for querying Bitcoin data.
