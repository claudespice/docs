...
| -------------------------- | --------------------------------------- | ----------------- | ------------ | ------------------------------- |
| [`file`](local)         | Local filesystem                        | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
| [`huggingface`](huggingface) | Models hosted on HuggingFace       | Release Candidate | ONNX         | GGUF, GGML, SafeTensor          |
