...
With the same semantics as [language models](/docs/building-blocks/model-providers/huggingface#access-tokens), `spice` can run private HuggingFace embedding models:
