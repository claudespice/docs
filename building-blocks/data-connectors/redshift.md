---
description: 'Connect to Amazon Redshift using the PostgreSQL connector.'
---

# Amazon Redshift Data Connector

Amazon Redshift is a columnar OLAP database compatible with PostgreSQL. To connect Redshift to Spice, use the [PostgreSQL data connector](postgres.md) and specify the Redshift cluster connection parameters.
...
Redshift types are mapped to PostgreSQL types. See the [PostgreSQL connector documentation](postgres.md) for details on supported types and configuration.

## References

- [Amazon Redshift Documentation](https://docs.aws.amazon.com/redshift/latest/mgmt/welcome.html)
- [PostgreSQL Connector Documentation](postgres.md)