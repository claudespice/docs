...
| [CSV](../../reference/file-format#csv) | `file_format: csv`     | ✅         | ❌                  |
...
File formats support additional parameters in the `params` (like `csv_has_header`) described in [File Formats](/reference/file-format)
