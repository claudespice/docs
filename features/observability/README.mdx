...
Observability in Spice enables task tracking and performance monitoring through a built-in distributed tracing system that can [export to Zipkin](zipkin) or be viewed via the [`runtime.task_history`](task-history) SQL table.
