...
Spice also supports vector search on datasets with preexisting embeddings. See [below](search-and-retrieval#pre-existing-embeddings) for compatibility details.
