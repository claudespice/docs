...
Customers who need resource limits, service-level guarantees, or priority support we offer [high-value paid tiers](../pricing/plans) based on usage.

### What level of support do you offer?

We offer enterprise-grade support with an SLA [for Enterprise Plans](../pricing/plans).
...
See [Security](../security/security). The Spice.ai Cloud Platform is SOC 2 Type II compliant.
