...
<Card href="portal-login" />

### Create a Spice app

<Card href="../getting-started/portal-login-1" />

### Add a dataset and query it

<Card href="step-2-add-dataset-and-query-data" />

### Add an AI Model and chat with it

<Card href="step-3-add-ai-model-and-chat-with-your-app" />
